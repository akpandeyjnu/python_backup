...
Diff_month_India = India_mean_UKCA_ak - India_mean_OMI
Diff_month_China = China_mean_UKCA_ak - China_mean_OMI
Diff_month_North_India = North_India_mean_UKCA_ak - North_India_mean_OMI
Diff_month_South_India = South_India_mean_UKCA_ak - South_India_mean_OMI
Diff_month_East_China = East_China_mean_UKCA_ak - East_China_mean_OMI
Diff_month_West_China = West_China_mean_UKCA_ak - West_China_mean_OMI
...
ax.plot(X1,Diff_month_India,c='b', linewidth=3);
tick_locs = [0,12,24,36,48,60,72,84,96,108,120,131]
tick_lbls = ['Jan-05', 'Jan-06','Jan-07', 'Jan-08','Jan-09', 'Jan-10','Jan-11', 'Jan-12','Jan-13','Jan-14', 'Jan-15','Dec-15']
...
plt.legend(('India diff UKCA - OMI' ,''),fontsize=30,loc='upper left')

ax = fig.add_subplot(322)
ax.plot(X1,Diff_month_China,c='b', linewidth=3);
plt.xticks(tick_locs, tick_lbls, fontsize = 25)
plt.ylim(-1e15, 8e15)
plt.yticks(fontsize = 25)
ax.yaxis.get_offset_text().set_size(25)
# plt.xlabel("Year 1998-2015", fontsize = 24)
plt.ylabel("NO$_2$ (molecules/cm$^2$)", fontsize = 30)
plt.legend(('China_UKCA_nudged' ,''),fontsize=30,loc='upper left')

ax = fig.add_subplot(323)
ax.plot(X1,Diff_month_North_India,c='r', linewidth=3);
plt.xticks(tick_locs, tick_lbls, fontsize = 25)
plt.ylim(-1e16, 3e16)
plt.yticks(fontsize = 25)
ax.yaxis.get_offset_text().set_size(25)
# plt.xlabel("Year 1998-2015", fontsize = 24)
plt.ylabel("NO$_2$ (molecules/cm$^2$)", fontsize = 30)
plt.legend(('North_India_UKCA_nudged' ,''),fontsize=30,loc='upper left')

ax = fig.add_subplot(324)
ax.plot(X1,Diff_month_East_China,c='r', linewidth=3);
plt.xticks(tick_locs, tick_lbls, fontsize = 25)
plt.ylim(-1e16, 3e16)
plt.yticks(fontsize = 25)
ax.yaxis.get_offset_text().set_size(25)
# plt.xlabel("Year 1998-2015", fontsize = 24)
plt.ylabel("NO$_2$ (molecules/cm$^2$)", fontsize = 30)
plt.legend(('East_China_UKCA_nudged' ,''),fontsize=30,loc='upper left')

ax = fig.add_subplot(325)
ax.plot(X1,Diff_month_South_India,c='g', linewidth=3);
plt.xticks(tick_locs, tick_lbls, fontsize = 25)
plt.ylim(-1e15, 1.5e15)
plt.yticks(fontsize = 25)
ax.yaxis.get_offset_text().set_size(25)
# plt.xlabel("Year 1998-2015", fontsize = 24)
plt.ylabel("NO$_2$ (molecules/cm$^2$)", fontsize = 30)
plt.legend(('South_India_UKCA_nudged' ,''),fontsize=30,loc='upper left')

ax = fig.add_subplot(326)
ax.plot(X1,Diff_month_West_China,c='g', linewidth=3);
plt.xticks(tick_locs, tick_lbls, fontsize = 25)
plt.ylim(-1e15, 1.5e15)
plt.yticks(fontsize = 25)
ax.yaxis.get_offset_text().set_size(25)
# plt.xlabel("Year 1998-2015", fontsize = 24)
plt.ylabel("NO$_2$ (molecules/cm$^2$)", fontsize = 30)
plt.legend(('West_China_UKCA_nudged' ,''),fontsize=30,loc='upper left')

plt.subplots_adjust(left=0.05, bottom=0.05, right=0.95, top=0.95, wspace=0.11, hspace=0.11);

plt.savefig('/exports/csce/datastore/geos/groups/alok_pandey/Research_Work/ESM2019/'+Today_date+'ts_mon_2005-2015_UKCA_OMI_Diff.png', dpi=200)   ##########	
plt.show()