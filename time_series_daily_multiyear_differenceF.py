...
Diff_daily_India = India_mean_mod - India_mean_sat
Diff_daily_China = China_mean_mod - China_mean_sat
Diff_daily_North_India = North_India_mean_mod - North_India_mean_sat
Diff_daily_South_India = South_India_mean_mod - South_India_mean_sat
Diff_daily_East_China = East_China_mean_mod - East_China_mean_sat
Diff_daily_West_China = West_China_mean_mod - West_China_mean_sat
...
ax1.plot(Diff_daily_India,c='b',linewidth=2);
...
plt.legend(('India diff UKCA - OMI','' ),fontsize = 24)
plt.ylabel("NO$_2$ (molecules/cm$^2$)", fontsize = 30)

ax2 = fig.add_subplot(322)
ax2.plot(Diff_daily_China,c='b',linewidth=2);
plt.xticks(xtick_locs, xtick_lbls, fontsize = 24)
plt.legend(('China diff UKCA - OMI' ,'' ),fontsize = 24, loc='upper right')
plt.ylim(-1e15, 9e15)
...
ax1.plot(Diff_daily_North_India,c='r',linewidth=2);
plt.xticks(xtick_locs, xtick_lbls, fontsize = 24)
plt.legend(('North_India diff UKCA - OMI' ,'' ),fontsize = 24, loc='upper right')
plt.ylim(-1e16, 5e16)
ax1.yaxis.get_offset_text().set_size(30)
ax1.yaxis.get_offset_text().set_color("red")
plt.yticks(fontsize = 24)
plt.ylabel("NO$_2$ (molecules/cm$^2$)", fontsize = 30)


ax1 = fig.add_subplot(324)
ax1.plot(Diff_daily_East_China,c='r',linewidth=2);
plt.xticks(xtick_locs, xtick_lbls, fontsize = 24)
plt.legend(('East_China diff UKCA - OMI' ,'' ),fontsize = 24, loc='upper right')
plt.ylim(-1e16, 5e16)
ax1.yaxis.get_offset_text().set_size(30)
ax1.yaxis.get_offset_text().set_color("red")
plt.yticks(fontsize = 24)
...
ax2.plot(Diff_daily_South_India,c='g',linewidth=2);
plt.xticks(xtick_locs, xtick_lbls, fontsize = 24)
plt.legend(('South_India diff UKCA - OMI' ,'' ),fontsize = 24,loc='upper right')
plt.ylim(-2e15, 5e15)
ax2.yaxis.get_offset_text().set_size(25)
plt.yticks(fontsize = 24)
plt.ylabel("NO$_2$ (molecules/cm$^2$)", fontsize = 30)
...
ax2.plot(Diff_daily_West_China,c='g',linewidth=2);
plt.xticks(xtick_locs, xtick_lbls, fontsize = 24)
plt.legend(('West_China diff UKCA - OMI' ,'' ),fontsize = 24,loc='upper right')
plt.ylim(-2e15, 5e15)
ax2.yaxis.get_offset_text().set_size(25)
plt.yticks(fontsize = 24)
plt.ylabel("NO$_2$ (molecules/cm$^2$)", fontsize = 30)
...
plt.savefig('/exports/csce/datastore/geos/groups/alok_pandey/Research_Work/ESM2019/'+Today_date+'Time_series_diff_Daily.png', dpi=300)   ##########	
plt.show()
